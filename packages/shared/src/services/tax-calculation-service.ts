...
/**
 * Zentraler Service für alle Steuerberechnungen
 * Wird sowohl für UI als auch PDF verwendet
 */
export class TaxCalculationService {
  ...
  /**
   * Berechnet die Werte für die UI-Anzeige (gleiche Logik wie PDF)
   */
  static calculatePartnerDisplayValues(partner: TaxPartner): {
    ...
    const differenz = haetteZahlenMuessen - hatGezahlt;

    return {
      haetteZahlenMuessen: Math.round(haetteZahlenMuessen * 100) / 100,
      hatGezahlt: Math.round(hatGezahlt * 100) / 100,
